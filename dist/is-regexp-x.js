/*!
{
  ...
  "date": "2019-07-15T19:25:34.438Z",
  "describe": "",
  "description": "Is this value a JS regex?",
  "file": "is-regexp-x.js",
  "hash": "15fa45f86c1d83dcccd7",
  "license": "MIT",
  "version": "3.0.0"
}
*/
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["isRegexpX"] = factory();
	else
		root["isRegexpX"] = factory();
})((function () {
  'use strict';
...
var libTrim = __webpack_require__(16);
var trim2016 = libTrim.trim2016;
var trim2018 = libTrim.trim2018;
var libParseInt = __webpack_require__(42);
...
var NAN = __webpack_require__(19);
...
var requireCoercibleToString = __webpack_require__(11);
var Rx = __webpack_require__(2).RegExp;
var reLeft2016 = new Rx('^[' + __webpack_require__(6).string2016 + ']+');
var reLeft2018 = new Rx('^[' + __webpack_require__(6).string2018 + ']+');
var replace = ''.replace;
...
var toStr = __webpack_require__(12);
...
var safeToString = __webpack_require__(26);
var toInteger = __webpack_require__(28).toInteger2018;
var toNumber = __webpack_require__(7).toNumber2018;
var mathClamp = __webpack_require__(46);
var MAX_SAFE_INTEGER = __webpack_require__(47);
...
var castString = __webpack_require__(2).String;
var pToString = __webpack_require__(27) && Symbol.prototype.toString;
...
var attempt = __webpack_require__(33);
var fToString = Function.prototype.toString;
var toBoolean = __webpack_require__(14);
var isFalsey = __webpack_require__(34);
var toStringTag = __webpack_require__(35);
var hasToStringTag = __webpack_require__(36);
var isPrimitive = __webpack_require__(38);
var normalise = __webpack_require__(39).normalizeSpace;
var deComment = __webpack_require__(41);
 ...
 * @type boolean
 */
module.exports = __webpack_require__(37) && typeof Symbol.toStringTag === 'symbol';
...
var trim2018 = libTrim.trim2018;
var Rx = __webpack_require__(2).RegExp;
var libWhiteSpace = __webpack_require__(6);
...
var requireCoercibleToString = __webpack_require__(11);
var Rx = __webpack_require__(2).RegExp;
var reRight2016 = new Rx('[' + __webpack_require__(6).string2016 + ']+$');
var reRight2018 = new Rx('[' + __webpack_require__(6).string2018 + ']+$');
var replace = ''.replace;
...
var NAN = __webpack_require__(19);
var toStr = __webpack_require__(12);
var trimLeft2016 = __webpack_require__(10).trimLeft2016;
var trimLeft2018 = __webpack_require__(10).trimLeft2018;
...
var numberIsNaN = __webpack_require__(13);
var INFINITY = __webpack_require__(44);
...
// CONCATENATED MODULE: ./node_modules/is-object-like-x/node_modules/attempt-x/dist/attempt-x.esm.js
/**
 * This method attempts to invoke the function, returning either the result or
 * the caught error object. Any additional arguments are provided to the
 * function when it's invoked.
...
// CONCATENATED MODULE: ./node_modules/is-object-like-x/node_modules/to-boolean-x/dist/to-boolean-x.esm.js
/**
 * The abstract operation ToBoolean converts argument to a value of type Boolean.
 *
 * @param {*} [value] - The value to be converted.
...
// CONCATENATED MODULE: ./node_modules/is-object-like-x/node_modules/is-falsey-x/dist/is-falsey-x.esm.js
...
// EXTERNAL MODULE: ./node_modules/is-object-like-x/node_modules/is-primitive/index.js
var is_primitive = __webpack_require__(8);
var is_primitive_default = /*#__PURE__*/__webpack_require__.n(is_primitive);

// CONCATENATED MODULE: ./node_modules/is-object-like-x/node_modules/is-nil-x/dist/is-nil-x.esm.js
/**
 * Checks if `value` is `null` or `undefined`.
 *
 * @param {*} [value] - The value to check.
...
// CONCATENATED MODULE: ./node_modules/has-own-property-x/node_modules/to-object-x/dist/to-object-x.esm.js
...
// CONCATENATED MODULE: ./node_modules/has-own-property-x/node_modules/attempt-x/dist/attempt-x.esm.js
/**
 * This method attempts to invoke the function, returning either the result or
 * the caught error object. Any additional arguments are provided to the
 * function when it's invoked.
...
var has_symbol_support_x_esm_hasSymbolSupport = dist_attempt_x_esm_attempt(function () {
...
var is_function_x_esm_hasNativeClass = dist_attempt_x_esm_attempt(function () {
...
var is_function_x_esm_isES6ClassFn = function isES6ClassFunc(value) {
  var result = dist_attempt_x_esm_attempt(is_function_x_esm_testClassstring, value);
  return result.threw === false && result.value;
};
/**
 * Checks if `value` is classified as a `Function` object.
...
var is_function_x_esm_tryFuncToString = function funcToString(value, allowClass) {
  ...
  return dist_attempt_x_esm_attempt.call(value, is_function_x_esm_fToString).threw === false;
};
/**
 * Checks if `value` is classified as a `Function` object.
 *
...
var symToPrimitive = dist_has_symbol_support_x_esm && Symbol.toPrimitive;
/* eslint-disable-next-line compat/compat */

var symValueOf = dist_has_symbol_support_x_esm && Symbol.prototype.valueOf;
var toStringOrder = ['toString', 'valueOf'];
var toNumberOrder = ['valueOf', 'toString'];
var orderLength = 2;
/**
...
function toPropertyKey(argument) {
  ...
  return dist_has_symbol_support_x_esm && _typeof(key) === 'symbol' ? key : to_string_x_esm_ToString(key);
}
...
function to_property_key_x_esm_toPropertyKey(argument) {
  var key = to_primitive_x_esm_toPrimitive(argument, String);
...
var is_string = __webpack_require__(20);
var is_string_default = /*#__PURE__*/__webpack_require__.n(is_string);

// EXTERNAL MODULE: ./node_modules/is-index-x/index.js
var is_index_x = __webpack_require__(21);
...
function propertyIsEnumerable(object, property) {
  return propIsEnumerable.call(to_object_x_esm_toObject(object), to_property_key_x_esm_toPropertyKey(property));
}
...
var object_get_own_property_descriptor_x_esm_doesGOPDWork = function doesGOPDWork(object, prop) {
  ...
  var testResult = attempt_x_dist_attempt_x_esm_attempt(nativeGOPD, object, prop);
...
if (nativeGOPD) {
  ...
  if (getOPDWorksOnDom) {
    var res = attempt_x_dist_attempt_x_esm_attempt(nativeGOPD, object_get_own_property_descriptor_x_esm_castObject('abc'), 1);
    ...
    if (worksWithStr) {
      ...
      if (getOPDWorksOnObject) {
        var worksWithPrim = attempt_x_dist_attempt_x_esm_attempt(nativeGOPD, 42, 'name').threw === false;
        /* eslint-disable-next-line compat/compat */
        ...
        if (worksWithObjSym) {
          if (worksWithPrim) {
            ...
            $getOwnPropertyDescriptor = function getOwnPropertyDescriptor(object, property) {
              return nativeGOPD(to_object_x_esm_toObject(object), property);
            };
          }
          ...
          $getOwnPropertyDescriptor = function getOwnPropertyDescriptor(object, property) {
            return nativeGOPD(to_object_x_esm_toObject(object), to_property_key_x_esm_toPropertyKey(property));
          };
        }
      } else {
...
if (dist_is_falsey_x_esm_isFalsey($getOwnPropertyDescriptor) || getOPDFallback1 || getOPDFallback2) {
  ...
  $getOwnPropertyDescriptor = function getOwnPropertyDescriptor(object, property) {
    var obj = to_object_x_esm_toObject(object);
    ...
    if (getOPDFallback1) {
      result = attempt_x_dist_attempt_x_esm_attempt.call(object_get_own_property_descriptor_x_esm_castObject, getOPDFallback1, obj, propKey);
    ...
    if (getOPDFallback2 && isStringIndex === false) {
      result = attempt_x_dist_attempt_x_esm_attempt.call(object_get_own_property_descriptor_x_esm_castObject, getOPDFallback2, obj, propKey);
...
// CONCATENATED MODULE: ./node_modules/object-define-property-x/node_modules/attempt-x/dist/attempt-x.esm.js
/**
 * This method attempts to invoke the function, returning either the result or
 * the caught error object. Any additional arguments are provided to the
 * function when it's invoked.
...
// CONCATENATED MODULE: ./node_modules/object-define-property-x/node_modules/to-boolean-x/dist/to-boolean-x.esm.js
/**
 * The abstract operation ToBoolean converts argument to a value of type Boolean.
 *
 * @param {*} [value] - The value to be converted.
...
// CONCATENATED MODULE: ./node_modules/object-define-property-x/node_modules/is-falsey-x/dist/is-falsey-x.esm.js
...
// CONCATENATED MODULE: ./node_modules/object-define-property-x/node_modules/is-nil-x/dist/is-nil-x.esm.js
/**
 * Checks if `value` is `null` or `undefined`.
 *
 * @param {*} [value] - The value to check.
...
// CONCATENATED MODULE: ./node_modules/object-define-property-x/node_modules/to-object-x/dist/to-object-x.esm.js
...
function dist_to_object_x_esm_toObject(value) {
  return dist_to_object_x_esm_castObject(node_modules_require_object_coercible_x_dist_require_object_coercible_x_esm_requireObjectCoercible(value));
}
...
// EXTERNAL MODULE: ./node_modules/object-define-property-x/node_modules/is-primitive/index.js
var object_define_property_x_node_modules_is_primitive = __webpack_require__(5);
var object_define_property_x_node_modules_is_primitive_default = /*#__PURE__*/__webpack_require__.n(object_define_property_x_node_modules_is_primitive);
...
function is_function_x_dist_is_function_x_esm_isFunction(value, allowClass) {
  if (object_define_property_x_node_modules_is_primitive_default()(value)) {
    return false;
  }
...
// CONCATENATED MODULE: ./node_modules/object-define-property-x/node_modules/to-primitive-x/dist/to-primitive-x.esm.js
...
var dist_to_primitive_x_esm_ordinaryToPrimitive = function _ordinaryToPrimitive(ordinary, hint) {
  ...
  for (var i = dist_to_primitive_x_esm_ZERO; i < dist_to_primitive_x_esm_orderLength; i += dist_to_primitive_x_esm_ONE) {
    ...
    if (is_function_x_dist_is_function_x_esm_isFunction(method)) {
      ...
      if (object_define_property_x_node_modules_is_primitive_default()(result)) {
        return result;
      }
    }
  }
...
function dist_to_primitive_x_esm_toPrimitive(input, preferredType) {
  if (object_define_property_x_node_modules_is_primitive_default()(input)) {
    return input;
  }
...
// CONCATENATED MODULE: ./node_modules/object-define-property-x/node_modules/to-property-key-x/dist/to-property-key-x.esm.js
function dist_to_property_key_x_esm_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { dist_to_property_key_x_esm_typeof = function _typeof(obj) { return typeof obj; }; } else { dist_to_property_key_x_esm_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return dist_to_property_key_x_esm_typeof(obj); }
...
function dist_to_property_key_x_esm_toPropertyKey(argument) {
  var key = dist_to_primitive_x_esm_toPrimitive(argument, String);
  return node_modules_has_symbol_support_x_dist_has_symbol_support_x_esm && dist_to_property_key_x_esm_typeof(key) === 'symbol' ? key : to_string_x_dist_to_string_x_esm_ToString(key);
}


// CONCATENATED MODULE: ./node_modules/assert-is-object-x/node_modules/attempt-x/dist/attempt-x.esm.js
/**
 * This method attempts to invoke the function, returning either the result or
 * the caught error object. Any additional arguments are provided to the
 * function when it's invoked.
 ...
 * @returns {object} Returns an object of the result.
 */
function assert_is_object_x_node_modules_attempt_x_dist_attempt_x_esm_attempt(fn) {
  try {
    for (var _len = arguments.length, args = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
      args[_key - 1] = arguments[_key];
    }
...
var node_modules_has_symbol_support_x_dist_has_symbol_support_x_esm_hasSymbolSupport = assert_is_object_x_node_modules_attempt_x_dist_attempt_x_esm_attempt(function () {
...
/* harmony default export */ var assert_is_object_x_node_modules_has_symbol_support_x_dist_has_symbol_support_x_esm = (node_modules_has_symbol_support_x_dist_has_symbol_support_x_esm_hasSymbolSupport.threw === false && node_modules_has_symbol_support_x_dist_has_symbol_support_x_esm_hasSymbolSupport.value === true);
...
var pToString = assert_is_object_x_node_modules_has_symbol_support_x_dist_has_symbol_support_x_esm && Symbol.prototype.toString;
...
var assert_is_object_x_node_modules_is_primitive = __webpack_require__(22);
var assert_is_object_x_node_modules_is_primitive_default = /*#__PURE__*/__webpack_require__.n(assert_is_object_x_node_modules_is_primitive);
...
function assertIsObject(value) {
  if (assert_is_object_x_node_modules_is_primitive_default()(value)) {
...
var toPropertyDescriptor = function _toPropertyDescriptor(desc) {
  var object = dist_to_object_x_esm_toObject(desc);
  var descriptor = {};
  ...
  if (has_own_property_x_esm_hasOwnProperty(object, 'get')) {
    ...
    if (typeof getter !== 'undefined' && is_function_x_dist_is_function_x_esm_isFunction(getter) === false) {
  ...
  if (has_own_property_x_esm_hasOwnProperty(object, 'set')) {
    ...
    if (typeof setter !== 'undefined' && is_function_x_dist_is_function_x_esm_isFunction(setter) === false) {
...
if (nativeDefProp) {
  var testWorksWith = function _testWorksWith(object) {
    var testResult = node_modules_attempt_x_dist_attempt_x_esm_attempt(nativeDefProp, object, 'sentinel', {});
    return testResult.threw === false && testResult.value === object && 'sentinel' in object;
  };

  var object_define_property_x_esm_doc = typeof document !== 'undefined' && document;

  if (testWorksWith({}) && (is_falsey_x_dist_is_falsey_x_esm_isFalsey(object_define_property_x_esm_doc) || testWorksWith(object_define_property_x_esm_doc.createElement('div')))) {
    $defineProperty = function defineProperty(object, property, descriptor) {
      return nativeDefProp(assertIsObject(object), dist_to_property_key_x_esm_toPropertyKey(property), toPropertyDescriptor(descriptor));
    };
  } else {
...
if (is_falsey_x_dist_is_falsey_x_esm_isFalsey(nativeDefProp) || definePropertyFallback) {
  ...
  $defineProperty = function defineProperty(object, property, descriptor) {
    ...
    var propKey = dist_to_property_key_x_esm_toPropertyKey(property);
    ...
    if (definePropertyFallback) {
      var result = node_modules_attempt_x_dist_attempt_x_esm_attempt.call(Object, definePropertyFallback, object, propKey, propDesc);
...
// CONCATENATED MODULE: ./dist/is-regexp-x.esm.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return isRegex; });
...
//# sourceMappingURL=is-regexp-x.js.map